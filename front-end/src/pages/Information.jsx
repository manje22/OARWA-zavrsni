  ...
  return (
    <div>
      <MainLayout>
        ...
        ></Banner>
        <div>
          <h1>Getting to the island of Šolta</h1>
          <p>
          ...
          <h1>Getting to Maslinica</h1>
          <h2>By car</h2>
          <p>
            If coming by car it is a 15 minute ride through the heart of the
            island to our property where parking will be provided
          </p>
          <h2>By bus</h2>
          <p>
            The bus line Rogač-Grohote-Gornje Selo-Maslinica departs from the
            port of Rogač shortly after the arrival of each ferry. Maslinica is
            the last stop and the bus will take you to the center of Maslinica.
            Our apartments are then just a short walk away
          </p>
          <h2>By taxi</h2>
          <p>
            If you wish to arrive by taxi contact us for further information
          </p>
        </div>
        <div id="mapContainer">
          <h1>Finding us on a map...</h1>
          <iframe
